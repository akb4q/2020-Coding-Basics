...
向人寻求帮助，会让问题变得印象深刻。有价值的问题比解决方案更重要。一般的问题可能其他人都有问过。但知乎、Quora、Reditt不是技术群体所在的地方，可以通过 [CSDN](https://www.csdn.net/), [stack Overflow](https://stackoverflow.com/)  等或者相应的论坛。
