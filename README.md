...
基于网上现存大量的关于编程的学习资源，该教程有其明确的学习方法和路径，不重复造轮子，但造车子。通过逆向工程思路，从一个原型项目出发，以逆向工程的方式，用新的知识点使其不断的迭代、演变、进化让学习变得更有趣，更带破解感。

本线上教学主要围绕 Github 这个开源平台，方便代码管理和内容维护。结合即时聊天工具方便沟通。
...
### 第一周 [第一章 逆向工程之 Bouncing Balls](https://bit.ly/2KQ9yvv)
