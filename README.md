...
在自学一段时间后，发现编程语言其实和数学并没有特别大的关系，顾虑也逐渐消除了。虽然算法也很重要，但笨办法也是办法，编程的主要目的是为了解决问题，这和艺术很像，但相反的是，艺术往往是在提出问题。
...
向人寻求帮助，会让问题变得映像深刻。有价值的问题比解决方案更重要。一般的问题可能其他人都有问过。但知乎、Quora、Reditt不是技术群体所在的地方，可以通过stackOverflow 等或者相应的论坛。
